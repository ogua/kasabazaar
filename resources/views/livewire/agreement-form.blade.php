    <div class="bg-gray-100 py-10">
        <div class="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-lg">
            ...
            <div class="text-center mb-8">
                <h1 class="text-3xl font-bold text-gray-700">KASAROSE LOGISTICS Shipping Agreement</h1>
            ...
            <div class="space-y-6 mb-8">
                ...
                <p class="text-sm text-gray-500">
                    By agreeing to the following terms, you consent to ship goods with KASAROSE LOGISTICS. Below are the
                ...
                <ul class="list-disc pl-6 space-y-2 text-sm text-gray-500">
                    ...
                    <li>KASAROSE LOGISTICS is not liable for delays caused by external factors like weather, customs, etc.</li>
                    ...
                    <li>Any prohibited items are not allowed for shipment, and KASAROSE LOGISTICS reserves the right to refuse
                        such shipments.</li>
                    <li>Shipment insurance is available and must be opted for during the shipping process.</li>
                    <li>KASAROSE LOGISTICS reserves the right to amend these terms at any time without prior notice.</li>
                </ul>
            </div>
            ...
            <div class="mt-8 text-center text-sm text-gray-500">
                <p>Thank you for choosing KASAROSE LOGISTICS for your shipping needs!</p>
            </div>
        </div>
    </div>
