...
<head>
    <meta charset="UTF-8">
    <title>Annual Investment Statement</title>
    <style>
        body {
...
<body>
    ...
    <div class="content">
        ...
        <p>Please find attached your annual investment statement for {{ $statement->year }}, summarizing your
            investment balance, interest earned, and total investment value for the year.</p>
