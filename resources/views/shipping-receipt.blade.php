        ...
        <table class="min-w-full divide-y divide-gray-200 text-sm">
            <thead class="bg-red-600 text-white">
                <tr>
                    ...
                    <th class="px-4 py-3 text-right">Shipping Price</th>
                </tr>
            </thead>
            <tbody class="bg-white divide-y divide-gray-100">
                <tr class="h-12">
                    <td class="font-extrabold">SHIPPING FEE</td>
                    <td class="">&nbsp;</td>
                ...
                <tr>
                    <td></td>
                    <td class="font-medium text-gray-700">Subtotal</td>
                ...
                <tr>
                    <td></td>
                    <td class="font-medium text-gray-700">Discount</td>
                    <td class="text-right">$0.00</td>
                </tr>
                <tr>
                    <td></td>
                    <td class="font-medium text-gray-700">Tax Rate</td>
                    <td class="text-right">0%</td>
                </tr>
                <tr>
                    <td></td>
                    <td class="font-medium text-gray-700">Total Tax</td>
                    <td class="text-right">$0.00</td>
                </tr>
