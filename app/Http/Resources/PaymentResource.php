    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'shipment' => $this->whenLoaded('shipment', fn () => $this->shipment ? [
                ...
                'total' => $this->shipment->total,
                'paid' => $this->shipment->paid,
                'payment_status' => $this->shipment->payment_status,
                'client' => $this->shipment->relationLoaded('client') && $this->shipment->client ? [
                    'name' => $this->shipment->client->name,
                    'phone' => $this->shipment->client->phone,
                ] : null,
            ] : null),
            ...
            'payment_receipt_url' => $this->id ? url("/payment-receipt/{$this->id}") : null,
        ];
    }
}
