...
class VendorProductController extends VendorBaseController
{
    public function index(Request $request): JsonResponse
    {
        $query = EcommerceProduct::where('vendor_id', $this->vendorId())
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        // Vendors cannot self-feature their own products — that stays a staff privilege.
        $product = EcommerceProduct::create(array_merge($data, [
            'vendor_id' => $this->vendorId(),
            'branch_id' => $this->vendor()->branch_id,
            'is_featured' => false,
        ]));
    ...
    {
        $product = EcommerceProduct::where('vendor_id', $this->vendorId())
            ->with(['category', 'images'])
            ->findOrFail($id);
    ...
    {
        $product = EcommerceProduct::where('vendor_id', $this->vendorId())->findOrFail($id);
