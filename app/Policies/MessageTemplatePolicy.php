...
class MessageTemplatePolicy
{
    ...
    {
        return $user->can('force_delete_message::template');
    }
    ...
    {
        return $user->can('force_delete_any_message::template');
    }
    ...
    {
        return $user->can('restore_message::template');
    }
    ...
    {
        return $user->can('restore_any_message::template');
    }
    ...
    {
        return $user->can('replicate_message::template');
    }
    ...
    {
        return $user->can('reorder_message::template');
    }
}
