...
use App\Filament\Client\Resources\PendingShipmentResource\RelationManagers;
...
class PendingShipmentResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Pending Shipments';

    protected static ?string $slug = 'pending-shipments';

    protected static ?string $modelLabel = 'Pending Shipments';
