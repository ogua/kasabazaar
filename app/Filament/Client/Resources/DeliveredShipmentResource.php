...
use App\Filament\Client\Resources\DeliveredShipmentResource\RelationManagers;
...
class DeliveredShipmentResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Delivered Shipments';

    protected static ?string $modelLabel = 'Delivered Shipments';

    protected static ?string $slug = 'delivered-shipments';
