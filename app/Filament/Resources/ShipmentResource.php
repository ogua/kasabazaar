                ...
                [
                    ActionGroup::make([
                        ...
                        Tables\Actions\Action::make('payments')
                            ...
                            ->fillForm(fn($record) => ['payments' => $record->payments])
                            ->infolist([
                                RepeatableEntry::make('payments')
                                    ->label('')
                                    ->schema([
                                        TextEntry::make('paying_method')->label('Method'),
                                        TextEntry::make('amount')->formatStateUsing(fn($state) => '$' . number_format($state, 2)),
                                        TextEntry::make('paid_on')->label('Date'),
                                    ])
                                    ->columns(3),
                            ])
                            ->modalSubmitAction(false),
