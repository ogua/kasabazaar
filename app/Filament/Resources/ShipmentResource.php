                                                                                                    ...
                                                                                                    ->schema([
                                                                                                        ...
                                                                                                        ->schema([
                                                                                                            ...
                                                                                                            ->infolist([
                                                                                                                ...
                                                                                                                ->label('')
                                                                                                                ->schema([
                                                                                                                    ImageEntry::make('receiver_name')
                                                                                                                    ->label(''),
                                                                                                                    TextEntry::make('receiver_phone'),
                                                                                                                    TextEntry::make('receiver_email'),
                                                                                                                    TextEntry::make('country')
                                                                                                                    ->state(fn($record) => "{$record->mcountry?->name}, {$record->mstate?->name}, {$record->mcity?->name}"),                                                                                                            TextEntry::make('receiver_phone'),
                                                                                                                    TextEntry::make('address'),
                                                                                                                    TextEntry::make('receiver_id_type'),
                                                                                                                    TextEntry::make('receiver_id_number'),                                                                                                            TextEntry::make('item_cost')
